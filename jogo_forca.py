...
temas = ['animais','comidas','politicos','ideologias']
tema = choice(temas)
#escolhe qual palavra vai ser sorteada
animais = ['soinho','galinha','vaca','gato','girafa']
comidas = ['melancia','peixe','manga','bolacha','feijao']
politicos = ['lula','bolsonaro','ciro','trump','daciolo']
ideologias = ['capitalismo','socialismo','comunismo','anarcocapitalismo']
if tema == 'animais':
    palavra = choice(animais)
elif tema == 'comidas':
    palavra = choice(comidas)
elif tema == 'politicos':
    palavra = choice(politicos)
elif tema == 'ideologias':
    palavra = choice(ideologias)
palavra2 = palavra
